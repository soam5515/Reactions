...
\centering
\begin{floatrow}
\subfloat{\includegraphics[width=.3\linewidth]{"deltavenL0"}}
\quad
\subfloat{\includegraphics[width=.3\linewidth]{"deltavenL1"}}
\quad
\subfloat{\includegraphics[width=.3\linewidth]{"deltavenL2"}}
\end{floatrow}
\end{figure}
\section{Resonances}
...
\centering
\begin{floatrow}
\subfloat{\includegraphics[width=.3\linewidth]{CrossSectionL0}}
\quad
\subfloat{\includegraphics[width=.3\linewidth]{CrossSectionL1}}
\quad
\subfloat{\includegraphics[width=.3\linewidth]{CrossSectionL2}}
\end{floatrow}
\end{figure}
